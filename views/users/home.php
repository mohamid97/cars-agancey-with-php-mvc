...
<div class="main-banner header-text">
    <div class="container-fluid">
        <div class="owl-banner owl-carousel">
            <div class="item">
                <img src="<?= getImage('2013-honda-accord-frontside_hoaccsed131.jpg' , 'users')?>" alt="">
                          ...
                          <div class="col-lg-8">
                              <div class="form-group">
                                  ...
                                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1"
                                         aria-describedby="emailHelp" placeholder="Type the name of the car">
                                  <small id="emailHelp" class="form-text  text text-danger">Type the name of the car .</small>
                              </div>
                          </div>
                          <div class="col-lg-4">
                              <div class="form-group">

                                  <input type="submit" value="search" class="form-control form-control-lg  btn btn-primary">
                              </div>
                          </div>
